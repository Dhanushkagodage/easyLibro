                      ...
                      child: Center(
                        child: Container(
                          decoration: BoxDecoration(
                            boxShadow: [
                              BoxShadow(
                                color: Color(0xFF080C27).withOpacity(0.5), // Shadow color
                                spreadRadius: 4, // Spread radius
                                blurRadius: 5, // Blur radius
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      DetailContainer(
                          label: "Available Qty.",
                          value: (resourceDetails.total - resourceDetails.borrowed).toString(),
                          icon: Icons.credit_score),
                      DetailContainer(
                          label: "Location",
                    ...
                    child: Container(
                      child: Column(
                        children: [
                          ...
                          TextdetailContainer(
                              label: "Publish Year", value: "2000"), // Add this to resource details
                          TextdetailContainer(label: "No.of Pages", value: resourceDetails.pages.toString()),
                          TextdetailContainer(
